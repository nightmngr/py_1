...
"""
Extra Credit
You can also add on to your Battleship! program
...
because you need to make sure that you don’t place 
battleships on top of each other on the game board. 
You'll also want to make sure that you balance the size 
of the board with the number of ships so the game is still 
...
touching and you’ll need to make sure you don’t accidentally place 
...
# func for random field on board
...
# print "random col: " + str(random_col(board))
